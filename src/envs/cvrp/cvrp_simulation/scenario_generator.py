...
class SampleDynamicBenchmark(ScenarioGenerator):
    ...
    def reset_customers(self, t, n_customer_to_create):
        ...
        # create a new time from distribution but only accept time that is larger than current cvrp time
        # allow 250 tries
        ...
        if indexs_to_use.size >= n_customer_to_create:
            ...
            print(
                ...
                f"{t:.3f},"
                f"using uniform between current time and final cvrp time - "
